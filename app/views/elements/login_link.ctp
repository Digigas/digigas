...
<ul>
	...
	<li><?php echo $this->Html->link('Benvenuto ' . $this->Session->read('Auth.User.fullname'), '/users'); ?></li>
	<li><?php echo $this->Html->link('Homepage', '/'); ?></li>
    <li><?php echo $this->Html->link('Admin', '/admin'); ?></li>
    <?php // per gli utenti normali
    else: ?>
    <li><?php echo $this->Html->link($this->Session->read('Auth.User.fullname') . ' - Impostazioni', '/users'); ?></li>
    <?php endif; ?>
