...
<?php echo $this->Form->create('MoneyBox');?>
	<fieldset>
 		<legend><?php printf(__('Admin Edit %s', true), __('Money Box', true)); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('MoneyBox.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('MoneyBox.id'))); ?></li>
